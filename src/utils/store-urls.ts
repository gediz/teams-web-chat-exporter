...
// signal here. The Edge URL is the Edge Add-ons store home as a placeholder;
// replace this constant with the listing URL once the extension passes
// Edge Add-ons certification.
...
const EDGE_ADDONS_REVIEW_URL = 'https://microsoftedge.microsoft.com/addons';
